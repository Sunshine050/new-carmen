import { ChatService } from './core/api-client.js';
import { UIManager } from './ui/ui-manager.js';
import { ChatManager } from './chat/chat-manager.js';
import { EventManager } from './chat/event-handler.js';
import { DEFAULT_CONFIG, SUGGESTED_QUESTIONS, STRINGS } from './core/constants.js';
...
export class CarmenBot {
    constructor(config = {}) {
        ...
        this.apiBase = (config.apiBase || DEFAULT_CONFIG.apiBase).replace(/\/$/, "");
        this.bu = config.bu;
        ...
        this.showClearHistoryButton = config.showClearHistoryButton ?? DEFAULT_CONFIG.showClearHistoryButton;
        this.showAttachFileButton = config.showAttachFileButton ?? DEFAULT_CONFIG.showAttachFileButton;

        this.suggestedQuestions = SUGGESTED_QUESTIONS;
        this.currentImageBase64 = null;
        // Always start fresh — user visits are session-based
        this.currentRoomId = null;
        localStorage.removeItem(`carmen_room_${this.bu}_${this.username}`);
    ...
    async init() {
        ...
        // Always show welcome — fresh session every page load
