...
const nextConfig = {
  ...
  async headers() {
    ...
    const csp = [
      ...
      "font-src 'self' data:",
      connectSrc,
      "frame-src https://www.youtube.com https://www.youtube-nocookie.com https://forms.zohopublic.com",
      "object-src 'none'",
      "base-uri 'self'",
      "form-action 'self'",
    ...
    return [
      {
        ...
        headers: [
          ...
          { key: "Permissions-Policy", value: 'camera=("https://forms.zohopublic.com"), microphone=(), geolocation=()' },
